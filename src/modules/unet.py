...
from .unet_blocks import (DownBlock2D,
                          ...
                          get_down_block,
                          get_up_block)
from .high_freq_fusion import AdaptiveHighFreqFusion, build_fusion_module
...
class UNet(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        reduction: int = 32,
        high_freq_fusion_type: str = "adaptive",
        use_intelligent_fusion: bool = True,
    ):
        super().__init__()
        ...
        # mid
        print("Load the mid block", "UNetMidMCABlock2D")
